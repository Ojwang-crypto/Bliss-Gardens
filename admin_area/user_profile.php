...
<?php 
    ...
    if(isset($_GET['user_profile'])){
        ...
        $user_county = $row_user['admin_county'];
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input value="<?php echo $user_county; ?>"  name="admin_county" type="text" class="form-control" required>
...
if(isset($_POST['update'])){
    ...
    $user_county = $_POST['admin_county'];
    ...
    $update_user = "update admins set admin_name='$user_name',admin_email='$user_email',admin_pass='$user_pass',admin_county='$user_county',admin_contact='$user_contact',admin_job='$user_job',admin_about='$user_about',admin_image='$user_image' where admin_id='$user_id'";
